...
export default function Index() {
    ...
    const getFeatureInfo = () => {
        ...
        useAxiosWithToken.post("/sabka/technical/annex/get/feature", params).then(res => {
            setFeatureData(WKTToPolygon(res.data.wkt))
    ...
    /*    return <MapBox polygonBounds={polygonPoints} /> */
    return (<>
        ...
        {(featureId && featureId !== "null" && featureData) ? <MapBox polygonBounds={featureData} /> : <MapBox center={[Number(farmLat), Number(farmLng)]} offset={0.002} />}
