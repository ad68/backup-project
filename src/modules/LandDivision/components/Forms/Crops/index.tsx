...
import useCropsLandDivision from "./cropsLandDivision.biz";
export default function Index() {
    const { isInfoModalOpen, setIsInfoModalOpen, ownerShipsOptions, irrigationSystemOptions, waterResourceOptions, control, errors, handleSubmit, onSubmit } = useCropsLandDivision()
