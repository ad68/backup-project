            ...
            {isOpenDtl && <> <span className="w-full block bg-slate-200 h-[1px]"></span>
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        ...
                        <span className="block text-sm break-words">چیچکلو</span>
                    </section>
                ...
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        ...
                        <span className="text-sm">تهران، اسلامشهر، احمد آباد مستوفی، چیچکلو</span>
                    </section>
                ...
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        ...
                        <span className="text-sm">در حال پایش</span>
                    </section>
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">قطعات:</span>
                        <span className="block text-sm break-words">1</span>
                    </section>
                </section>
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">بازدیدها:</span>
                        <span className="block text-sm break-words">6</span>
                    </section>
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">مستندات:</span>
                        <span className="block text-sm break-words">11</span>
                    </section>
                </section>

                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">عملکرد کمی:</span>
                        <span className="block text-sm break-words">..........</span>
                    </section>
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">عملکرد کیفی:</span>
                        <span className="block text-sm break-words">..........</span>
                    </section>
                </section>
            </>}
