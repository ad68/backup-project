        ...
        <section className="m-auto  relative bg-primary max-w-5xl h-full">
            <section className="absolute w-full top-0 h-[400px] left-0 overflow-hidden">
                ...
                <section className=' flex justify-center w-full pl-2 mt-5'>
                    <img src="/images/login/sandoogh-logo.svg" className="w-[110px] mt-[30px]" alt="" />
                </section>
                ...
                <span className='block mt-[20px] text-white w-full text-center text-[20px] font-bold'>سامانه ارزیابی صندوق بیمه کشاورزی</span>
            </section>
            <LoginForm />
        </section>
