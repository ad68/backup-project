...
export default function Index() {
    const { saveData, setSubjectNotExist, subjectNotExist } = useSubjectNotExist()
    return <>
        ...
        <section className="p-2">
            <div className="border border-[#2ebf704f] rounded-md flex flex-col  gap-1 p-2">
                <div className="flex  gap-2">
                    <div dir="ltr" className="flex items-center">
                        <Switch checked={subjectNotExist} onCheckedChange={(value) => setSubjectNotExist(value)} />
                    </div>
            ...
            <section className="flex px-2 bg-white bottom-0 gap-2 mt-4 py-3 justify-end w-full">
                <CustomButton onClick={saveData} className="rounded-full w-full">
                    <span>ثبت</span>
                </CustomButton>
            </section>
        </section>
