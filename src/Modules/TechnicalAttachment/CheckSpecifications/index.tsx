...
import useCheckSpecifications from './checkSpecifications.biz'
import ListLoader from '@/components/kit/ListLoader'
import NoRecord from '@/components/kit/NoRecord'
export default function Index() {
    const { data, loading, setCurrentPage, totalPage, currentPage, setSearchParams } = useCheckSpecifications()
