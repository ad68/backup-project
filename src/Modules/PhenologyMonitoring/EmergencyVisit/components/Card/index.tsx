    ...
    return <section className="w-[440px] max-w-full p-2">
        <section className={`border relative flex flex-col gap-4 bg-white border-slate-100  p-4 pb-12 rounded-2xl ${isOpenDtl ? `h-auto` : `h-[122px]`} shadow-lg`}>
            ...
            {isOpenDtl && <> <span className="w-full block bg-slate-200 h-[1px]"></span>
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">منطقه منتخب:</span>
                        <span className="block text-sm break-words">فیروزکوه</span>
                    </section>
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">پرونده پایش:</span>
                        <span className="block text-sm break-words">127712</span>
                    </section>
                </section>
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">شماره بازدید:</span>
                        <span className="block text-sm break-words">اضطراری اول</span>
                    </section>

                </section>
                <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">از تاریخ:</span>
                        <span className="block text-sm break-words">1403/11/15</span>
                    </section>
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">تا تاریخ:</span>
                        <span className="block text-sm break-words">1403/12/01</span>
                    </section>
                </section> <section className="flex justify-between w-full">
                    <section className="flex gap-1">
                        <span className="font-light text-slate-500 text-sm">ملاحظات:</span>
                        <span className="block text-sm break-words">بازدید توسط خانم خرمایی</span>
                    </section>
