    ...
    return <section>
        <section className="pt-[110px] px-5">
            <section className="grid grid-cols-2 gap-5">
                ...
                <Tile iconBgColor='bg-[#ffffeb]' borderColorClass={'border-yellow-400'} title="آموزش" image={<TeachIcon className="text-yellow-400 w-[21px]" />} />
                <Tile iconBgColor='bg-[#e2f9ff]' borderColorClass={'border-[#15cefa]'} title="قوانین و قررات" image={<TeachIcon className="text-[#15cefa] w-[21px]" />} />
            </section>
